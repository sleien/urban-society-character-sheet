...
$(document).ready(function(argument) {
    ...
    //Load Attributes
    $('#page-1 #attributes input[name="phy"]').val(loadJson.page1.attributes.phy);
    $('#page-1 #attributes input[name="phy-mod"]').val(loadJson.page1.attributes.str_mod);
    $('#page-1 #attributes input[name="agi"]').val(loadJson.page1.attributes.agi);
    $('#page-1 #attributes input[name="agi-mod"]').val(loadJson.page1.attributes.dex_mod);
    $('#page-1 #attributes input[name="end"]').val(loadJson.page1.attributes.end);
    $('#page-1 #attributes input[name="end-mod"]').val(loadJson.page1.attributes.con_mod);
    $('#page-1 #attributes input[name="exp"]').val(loadJson.page1.attributes.exp);
    $('#page-1 #attributes input[name="exp-mod"]').val(loadJson.page1.attributes.int_mod);
    $('#page-1 #attributes input[name="ins"]').val(loadJson.page1.attributes.ins);
    $('#page-1 #attributes input[name="ins-mod"]').val(loadJson.page1.attributes.wis_mod);
    $('#page-1 #attributes input[name="inf"]').val(loadJson.page1.attributes.inf);
    $('#page-1 #attributes input[name="inf-mod"]').val(loadJson.page1.attributes.cha_mod);
    ...
    $('#page-1 #saves-skills #saves input[name="phy-save"]').val(loadJson.page1.saves_skills.saves.str_save.val);
    $('#page-1 #saves-skills #saves #phy-save input[name="prof"]').prop("checked", loadJson.page1.saves_skills.saves.str_save.prof);
    $('#page-1 #saves-skills #saves input[name="agi-save"]').val(loadJson.page1.saves_skills.saves.dex_save.val);
    $('#page-1 #saves-skills #saves #agi-save input[name="prof"]').prop("checked", loadJson.page1.saves_skills.saves.dex_save.prof);
    $('#page-1 #saves-skills #saves input[name="end-save"]').val(loadJson.page1.saves_skills.saves.con_save.val);
    $('#page-1 #saves-skills #saves #end-save input[name="prof"]').prop("checked", loadJson.page1.saves_skills.saves.con_save.prof);
    $('#page-1 #saves-skills #saves input[name="exp-save"]').val(loadJson.page1.saves_skills.saves.int_save.val);
    $('#page-1 #saves-skills #saves #exp-save input[name="prof"]').prop("checked", loadJson.page1.saves_skills.saves.int_save.prof);
    $('#page-1 #saves-skills #saves input[name="ins-save"]').val(loadJson.page1.saves_skills.saves.wis_save.val);
    $('#page-1 #saves-skills #saves #ins-save input[name="prof"]').prop("checked", loadJson.page1.saves_skills.saves.wis_save.prof);
    $('#page-1 #saves-skills #saves input[name="inf-save"]').val(loadJson.page1.saves_skills.saves.cha_save.val);
    $('#page-1 #saves-skills #saves #inf-save input[name="prof"]').prop("checked", loadJson.page1.saves_skills.saves.cha_save.prof);
    ...
    $('#page-2 #currancy input[name="exo"]').val(loadJson.page2.equipment.currency.exo);
    $('#page-2 #currancy input[name="laks"]').val(loadJson.page2.equipment.currency.laks);
