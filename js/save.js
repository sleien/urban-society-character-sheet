...
function saveSheet(argument) {
    ...
    var sheet = {
        page1: {
            ...
            attributes: {
                phy: $('#page-1 #attributes input[name="phy"]').val(),
                str_mod: $('#page-1 #attributes input[name="phy-mod"]').val(),
                agi: $('#page-1 #attributes input[name="agi"]').val(),
                dex_mod: $('#page-1 #attributes input[name="agi-mod"]').val(),
                end: $('#page-1 #attributes input[name="end"]').val(),
                con_mod: $('#page-1 #attributes input[name="end-mod"]').val(),
                exp: $('#page-1 #attributes input[name="exp"]').val(),
                int_mod: $('#page-1 #attributes input[name="exp-mod"]').val(),
                ins: $('#page-1 #attributes input[name="ins"]').val(),
                wis_mod: $('#page-1 #attributes input[name="ins-mod"]').val(),
                inf: $('#page-1 #attributes input[name="inf"]').val(),
                cha_mod: $('#page-1 #attributes input[name="inf-mod"]').val()
            },
            saves_skills: {
                spell_casting: $('#page-1 #saves-skills select[name="spell-att"]').val(),
                saves: {
                    str_save: {
                        val: $('#page-1 #saves-skills #saves input[name="phy-save"]').val(),
                        prof: $('#page-1 #saves-skills #saves #phy-save input[name="prof"]').prop("checked")
                    },
                    dex_save: {
                        val: $('#page-1 #saves-skills #saves input[name="agi-save"]').val(),
                        prof: $('#page-1 #saves-skills #saves #agi-save input[name="prof"]').prop("checked")
                    },
                    con_save: {
                        val: $('#page-1 #saves-skills #saves input[name="end-save"]').val(),
                        prof: $('#page-1 #saves-skills #saves #end-save input[name="prof"]').prop("checked")
                    },
                    int_save: {
                        val: $('#page-1 #saves-skills #saves input[name="exp-save"]').val(),
                        prof: $('#page-1 #saves-skills #saves #exp-save input[name="prof"]').prop("checked")
                    },
                    wis_save: {
                        val: $('#page-1 #saves-skills #saves input[name="ins-save"]').val(),
                        prof: $('#page-1 #saves-skills #saves #ins-save input[name="prof"]').prop("checked")
                    },
                    cha_save: {
                        val: $('#page-1 #saves-skills #saves input[name="inf-save"]').val(),
                        prof: $('#page-1 #saves-skills #saves #inf-save input[name="prof"]').prop("checked")
                    },
                },
                skills: {
                    acrobatics: {
        ...
        page2: {
            equipment: {
                ...
                currency: {
                    exo: $('#page-2 #currancy input[name="exo"]').val(),
                    laks: $('#page-2 #currancy input[name="laks"]').val(),
    ...
    var saveString = JSON.stringify(sheet);

    //save into local storage
    localStorage.setItem('savedSheet', saveString);
